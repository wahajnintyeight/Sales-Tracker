            ...
            <form action="{{ route('admin.goals.add') }}" class="m-2" method="post">
                ...
                <section class="org-kpi">
                    ...
                    <div id="input" class="p-3 org-kpi">
                        ...
                        <textarea placeholder="Describe the Goal" type="text" name="description"
            ...
            <table class="table table-report sm:mt-2" id="myTable">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="w-22">
                            <a href="" class="font-medium whitespace-nowrap">{{ mb_strimwidth($goal->description, 0, 40,
                                '...') }}</a>
                        </td>
                        <td class="w-16">
                        ...
                        <td class="w-28">
                            <div class="flex  items-center">
                                <a class="flex bg btn btn-warning  mr-3" href=""> <i data-feather="check-square"
                                ...
                                <a class="flex mr-3 btn btn-primary" href="javascript:;" data-tw-toggle="modal"
                                    data-tw-target="#team-modal-preview-{{ $key }}"> <i data-feather="activity"
                                        class="w-4 h-4 mr-1"></i> Add Activity </a>

                            </div>
                        </td>
                        <div id="team-modal-preview-{{ $key }}" class="modal" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="w-full"> <label for="modal-form-6"
                                                ...
                                                <div>
                                                    <div class="mt-2">
                                                        ...
                                                        <div class="relative w-full mx-auto mt-2">
                                                            <div> <label for="regular-form-1" class="form-label">Select
                                                                    Title</label> <input id="regular-form-1" type="text"
