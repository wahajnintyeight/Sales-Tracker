                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="w-10">
                            ...
                            <a href="" class="font-medium whitespace-nowrap">{{ $user->team['name'] }}</a>
                            @else
                        ...
                        <td class="table-report__action w-64">
                            <div class="flex  items-center">
                                ...
                                <div class="text-center p-1">
                                    <a href="javascript:;" data-tw-toggle="modal"
                                        data-tw-target="#delete-modal-preview-{{ $key }}" class="btn btn-danger m-1">
                                ...
                                <div class="text-center p-1">
                                    <a href="javascript:;" data-tw-toggle="modal"
                                        data-tw-target="#team-modal-preview-{{ $key }}" class="btn btn-primary m-1">
                                    ...
                                    <form action="{{ route('admin.teams.assign.user') }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="w-full"> <label for="modal-form-6" class="form-label">Select
                                                ...
                                                {{-- <select id="modal-form-6" class="form-select w-full"
                                                    name="team_id"> --}}
