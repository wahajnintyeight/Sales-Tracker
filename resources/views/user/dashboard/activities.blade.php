                    ...
                    <div id="input" class="p-3 org-kpi">
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="col-span-4">
                                ...
                                <input type="text" class="form-control datepicker block col-span-4" name="performed_on"
            ...
            <table class="table table-report sm:mt-2" id="myTable">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="w-5">
                            <a href="" class="font-medium whitespace-nowrap">{{ $entry->organizationGoal->name }}</a>
                        </td>
                        <td class="w-5">
