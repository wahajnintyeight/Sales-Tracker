                                        ...
                                        <div class="flex">
                                            ...
                                            <span class="m-1 p-2">
                                                ...
                                                <span class="text-base text-slate-500">({{
                                                    $cardInfo['totalPitchesMade'][$index] }}
                                                    Made)
                                                </span>
                                            </span>
                                            @else
                                    ...
                                    <div class="text-2xl font-medium leading-8 mt-6">
                                        <div class="flex">
                                            ...
                                            <span class="m-1 p-2">
                                                ...
                                                calls to
                                                go! <span class="text-base text-slate-500">({{
                                                    $cardInfo['totalCallsMade'][$index] }}
                                                    Made)</span>
                                            </span>
                                            @else
                                            <span class="m-1 p-2">
                            ...
                            <div class="w-full z-50">
                                <div class="flex">
                                    <div class="w-1/2">
                                        ...
                                        <span class="block mx-auto m-2 font-medium text-center p-2">Daily Average
                                            Entries</span>
                                    </div>

                                    <div class="w-1/2">
                                        <canvas width=350 height=190 class="justify-center" id="calls-gauge"></canvas>
                                        <div id="preview-textfield"></div>
