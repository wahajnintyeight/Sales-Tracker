                                ...
                                <div data-tab-content="" class="p-5">
                                    {{-- <div class="grid grid-cols-12 gap-6 mt-5"> --}}
                                        @foreach ($cardInfo['goals'] as $goalIndex => $goal)
                                            @if ($goalIndex == 0)
                                                <div class="block opacity-100 grid grid-cols-12 gap-6 mt-5" id="g{{ $goal->id }}" role="tabpanel">
                                                    <div
                                                        ...
                                                        <div class="w-full z-50" style="margin-top:100px">
                                                            <canvas
                                                                id="daily-organizations-reached{{ $goal->id }}"></canvas>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="w-full" style="margin-top:50px">
                                                            ...
                                                            <div id="preview-textfield"></div>
                                                            <span
                                                                class="block mx-auto m-2 font-medium text-center p-2">NAP</span>
                                                        </div>
                                                    </div>
                                                    {{-- NAP GAUGE 2 END --}}
                                                    {{-- CHART --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <div id="preview-textfield"></div>
                                                            <span
                                                                class="block mx-auto m-2 font-medium text-center p-2">FUP</span>
                                                        </div>
                                                        {{-- </div> --}}
                                                    </div>
                                                    {{-- FUP GAUGE 1 END --}}
                                                                            ...
                                                                            <div class="text-2xl font-medium leading-8 mt-6">
                                                                                <div class="flex">
                                                                                    ...
                                                                                    <span class="m-1 p-2">
                                                                                        ...
                                                                                        <span
                                                                                            class="text-base text-slate-500">(0
                                                                                            Made)</span>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                            ...
                                            @else
                                                <div class="hidden opacity-0 grid grid-cols-12 gap-6 mt-5" id="g{{ $goal->id }}" role="tabpanel">
                                                    <div
                                                        class="col-span-12 sm:col-span-12 xl:col-span-4 intro-y box p-5 zoom-in z-0">
                                                        <span class="block mx-auto mt-2 font-bold text-start p-2"
                                                            style="font-size: 20px">Organization Accomplishments Report
